...
# le chemin du projet.
param([string]$Root = "C:\Users\denne\haute-capitale-dialogue")

Get-CimInstance Win32_Process -Filter "Name = 'javaw.exe' OR Name = 'java.exe'" |
    Where-Object { $_.CommandLine -and $_.CommandLine -like "*$Root*" -and $_.CommandLine -like "*net.fabricmc.devlaunchinjector*" } |
    ForEach-Object {
