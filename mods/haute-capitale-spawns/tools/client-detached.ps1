...
param(
    ...
    [string]$Server = "127.0.0.1:25567"
)

$root = "C:\Users\denne\haute-capitale-spawns"
...
$gameArgs = if ($Server -eq "") { "--username $Username" } else { "--username $Username --quickPlayMultiplayer $Server" }
