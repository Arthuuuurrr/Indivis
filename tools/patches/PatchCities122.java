...
public class PatchCities122 {
  ...
  static final String[] CITIES={
    ...
    "indivis:sombrefleche","indivis:clos_des_ormes"
  };
  ...
  static void write(ClassNode cn, Path p) throws Exception {
    ...
    cn.accept(cw); Files.write(p,cw.toByteArray());
  }
  ...
  static void patchSpawn(Path in,Path out)throws Exception{
    ...
    il.add(new LdcInsnNode("[Capitale Creatures] 1.2.22 exact city RegistryKey no-spawn guard active (14 city biomes)"));
