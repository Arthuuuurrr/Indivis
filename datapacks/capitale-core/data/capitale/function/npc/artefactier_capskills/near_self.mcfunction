# RC9g — Near Distance dialogue marchand : Marchand d'artefacts
...
execute if score @s NPC_NEAR_CD matches 0 run function capitale:npc/artefactier_capskills/talk_self
