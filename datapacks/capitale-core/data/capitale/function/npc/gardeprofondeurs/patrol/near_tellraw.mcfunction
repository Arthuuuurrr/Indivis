...
execute unless score @s CAP_CRIME matches 10.. unless score @s NPC_NEAR_CD matches 1.. run function capitale:npc/gardeprofondeurs/patrol/dialogue/near/route
