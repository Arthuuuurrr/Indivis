...
scoreboard players set @e[type=armor_stand,tag=guide_gardeprofondeurs_patrol_16,limit=1] NPC_PATROL_MODE 0
...
tellraw @s {"text": "[Gardes des Profondeurs] Patrouille 16 démarrée.", "color": "gray"}
