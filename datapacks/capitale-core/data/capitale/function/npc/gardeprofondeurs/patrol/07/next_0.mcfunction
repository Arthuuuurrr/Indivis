...
execute unless entity @e[type=marker,tag=wp_gardeprofondeurs_patrol_07_b,limit=1] if entity @e[type=marker,tag=wp_gardeprofondeurs_patrol_07_a,limit=1] run tp @s @e[type=marker,tag=wp_gardeprofondeurs_patrol_07_a,limit=1]
