...
scoreboard players set @e[type=armor_stand,tag=guide_gardeprofondeurs_patrol_02,limit=1] NPC_PATROL_MODE 0
...
tellraw @s {"text": "[Gardes des Profondeurs] Patrouille 02 démarrée.", "color": "gray"}
