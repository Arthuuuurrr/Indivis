...
execute if entity @e[type=marker,tag=wp_gardeprofondeurs_patrol_12_b,limit=1] run scoreboard players set @s NPC_PATROL_DIR 0
...
execute unless entity @e[type=marker,tag=wp_gardeprofondeurs_patrol_12_b,limit=1] run scoreboard players set @s NPC_PATROL_DIR 0
