...
scoreboard players set @s CAP_TEMOIN_QUAI_C 1
function capitale:quest/journalieres/temoignages_quais/count_self
function capitale:dialogue/sound/parole_quete_self
tellraw @s [{"text":"[Clerc des Bordereaux]","color":"yellow"},{"text":" : Le sceau du lot est bon, mais l’heure reportée ne colle pas. Si vous me demandez, l’erreur est née après l’arrivée, pas avant.","color":"white"}]
