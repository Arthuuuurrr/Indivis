...
scoreboard players set @s CAP_TEMOIN_QUAI_B 1
function capitale:quest/journalieres/temoignages_quais/count_self
function capitale:dialogue/sound/parole_quete_self
tellraw @s [{"text":"[Marinière]","color":"yellow"},{"text":" : La dispute a commencé avant même qu’on ouvre les registres. Quelqu’un savait déjà qu’il manquerait un bordereau.","color":"white"}]
