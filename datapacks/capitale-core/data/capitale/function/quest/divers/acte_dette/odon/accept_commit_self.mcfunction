...
tellraw @s [{"text":"[Odon Varenne]","color":"yellow"},{"text":" : Le Quartier des Vieilles Mécaniques s’étend autour d’un vieux clocher ; Lucain tient un atelier non loin de là. Il vous parlera de justice, forcément. Les débiteurs commencent toujours par les grands mots.","color":"white"}]
function capitale:dialogue/sound/parole_quete_self
