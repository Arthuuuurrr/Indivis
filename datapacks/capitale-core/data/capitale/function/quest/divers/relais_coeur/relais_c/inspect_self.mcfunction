...
scoreboard players set @s CAP_RELAIS_COEUR_C 1
function capitale:quest/divers/relais_coeur/count_self
function capitale:dialogue/sound/parole_quete_self
tellraw @s [{"text":"[Relais inférieur]","color":"yellow"},{"text":" : Vous ajustez les cadrans visibles et laissez la borne retrouver un cycle plus régulier.","color":"white"}]
