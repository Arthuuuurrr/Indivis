...
execute if score @s CAP_FLAG matches 0 if score @s QUEST_DIVERS_LAMPE matches 10 if score @s CAP_GLOBE_L3 matches 0 run scoreboard players set @s CAP_FLAG 2
execute if score @s CAP_FLAG matches 2 run function capitale:quest/divers/lampe_manquante/globe/recalibrate_3_self
execute if score @s CAP_FLAG matches 0 if score @s QUEST_DIVERS_LAMPE matches 10 if score @s CAP_GLOBE_L3 matches 1.. run scoreboard players set @s CAP_FLAG 3
