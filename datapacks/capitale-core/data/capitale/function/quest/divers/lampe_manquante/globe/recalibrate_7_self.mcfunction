scoreboard players set @s CAP_GLOBE_L7 1
scoreboard players add @s CAP_GLOBE_DONE 1
function capitale:dialogue/sound/parole_quete_self
tellraw @s [{"text":"[Lanterne 7 du Globe]","color":"yellow"},{"text":" : Vous réglez la lanterne 7. Sa flamme se clarifie et rejoint le rythme du socle.","color":"white"}]
