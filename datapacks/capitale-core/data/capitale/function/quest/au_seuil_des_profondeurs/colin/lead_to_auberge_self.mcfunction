...
execute if score @s CAP_QUETEACTIVE matches 5 run scoreboard players set @s CAP_FLAG 1
execute if score @s CAP_FLAG matches 1 run function capitale:quest/au_seuil_des_profondeurs/colin/lead_to_auberge_commit_self
