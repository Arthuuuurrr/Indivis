execute if entity @e[type=marker,tag=wp_colin_profondeurs_a,limit=1] run tp @e[tag=npc_colin_ferand,limit=1] @e[type=marker,tag=wp_colin_profondeurs_a,limit=1]
...
scoreboard players set @e[type=armor_stand,tag=guide_colin_profondeurs] NPC_RETURN_TIMER 0
