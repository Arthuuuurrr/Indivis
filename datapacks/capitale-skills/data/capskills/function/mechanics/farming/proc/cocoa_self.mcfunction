...
execute if entity @s[tag=capskills.farming.r2] if score #roll CAPSK_TMP matches ..45 run give @s minecraft:cocoa_beans 2
execute unless entity @s[tag=capskills.farming.r2] if entity @s[tag=capskills.farming.r1] if score #roll CAPSK_TMP matches ..25 run give @s minecraft:cocoa_beans 2
...
execute if entity @s[tag=capskills.farming.r2] if score #food CAPSK_TMP matches ..8 run give @s minecraft:cookie 8
execute if entity @s[tag=capskills.farming.r2] if score #food CAPSK_TMP matches 9..24 run give @s minecraft:cookie 4
execute unless entity @s[tag=capskills.farming.r2] if entity @s[tag=capskills.farming.r1] if score #food CAPSK_TMP matches ..10 run give @s minecraft:cookie 4
