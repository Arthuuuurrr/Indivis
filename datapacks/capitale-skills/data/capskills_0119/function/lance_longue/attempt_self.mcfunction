# Entrée validée par le payload dédié sprint + clic droit.
...
execute unless entity @s[tag=capskills_0119.lance_longue.channeling] unless entity @s[tag=capskills_0119.lance_longue.active] if score @s CAPSK_LANCE_CD matches 0 run function capskills_0119:lance_longue/acquire_self
