...
damage @s 7 minecraft:generic by @a[tag=capskills_0130.double_lame.caster,limit=1]
...
title @a[tag=capskills_0130.double_lame.caster,limit=1] actionbar {"text":"Sentence exécutée — dague/rapière/griffe et autre finesse.","color":"dark_red"}
