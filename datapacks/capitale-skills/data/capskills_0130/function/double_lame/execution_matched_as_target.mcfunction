...
damage @s 6.5 minecraft:generic by @a[tag=capskills_0130.double_lame.caster,limit=1]
effect give @s minecraft:weakness 3 0 true
effect give @s minecraft:glowing 3 0 true
title @a[tag=capskills_0130.double_lame.caster,limit=1] actionbar {"text":"Sentence exécutée — paire assortie.","color":"red"}
